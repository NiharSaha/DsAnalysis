//********************************
//Orginal Author: Cesar, Milan
//Modified and maintained by Nihar
//********************************
...
Float_t max_Dcabin[N_DCABIN]={0.012};
TString label_Dcabin[N_DCABIN]={"0to0p012"};
TString Dcabin[N_DCABIN]={"0 < dcaSig < 0.012"};
Double_t dcabinning[N_DCABIN+1]={0.0, 0.012};
...
void hist_vn_mass(TString input_file, int itxtoutFile, TString out_file ){
  ...
  std::string outfilename = Form("%s/Hist_QQnVsMass_MB0to19_withDCA0p012_%s_%d" , out_file.Data(), date, itxtoutFile);
